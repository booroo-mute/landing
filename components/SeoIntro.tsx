        ...
        <div className="max-w-[920px] mx-auto">
          ...
          <div className="mt-6 md:mt-8 flex flex-col gap-5 md:gap-6">
            <p className="body-text text-text-secondary">
              ...
              каждый созвон с друзьями начинается с вопроса «а у тебя
              открывается?». Mute (читается «мьют», часто пишут просто «мут»)
              избавляет от этого вопроса. Это игровой голосовой чат, приложение
              для общения геймеров, которое открывается в России напрямую,
            ...
            <p className="body-text text-text-secondary">
              ...
              запутаться. Открываешь список друзей и звонишь. Одной строкой:
              голосовая связь для игр на ПК и чат для геймеров, на двоих или
              на компанию друзей до восьми человек, который работает в России.
            </p>
            <p className="body-text text-text-secondary">
              Mute бесплатный, подписок и платных функций в нём нет. Приложение
              есть для Windows и macOS, а ещё Mute открывается прямо в
              браузере, так что{" "}
              <Link href="/voice-chat" className="text-accent hover:underline">созвониться с другом онлайн</Link>{" "}
              можно даже с телефона или чужого компьютера. Интерфейс маленький:
              в нём нет серверов, каналов и магазина, только то, что нужно
              для созвона. Если в вашей игре войс отключили или он не работает,
              загляните в{" "}
              <Link href="/games" className="text-accent hover:underline">гайды по голосовому чату в играх</Link>.
            </p>
            <p className="body-text text-text-secondary">
