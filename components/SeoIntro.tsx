        ...
        <div className="max-w-[920px] mx-auto">
          ...
          <div className="mt-6 md:mt-8 flex flex-col gap-5 md:gap-6">
            ...
            <p className="body-text text-text-secondary">
              ...
              личные сообщения и групповые чаты. При этом в Mute нет публичных
              серверов с каналами, ролями и правами, в которых легко
            ...
            <p className="body-text text-text-secondary">
              ...
              компьютера. Само приложение лёгкое и не грузит систему во время
              игры.
            </p>
            <p className="body-text text-text-secondary">
