...
export default function ButtonPrimary({ icon, children, href, target }: ButtonPrimaryProps) {
  const className = "w-full lg:w-fit px-6 md:px-8 lg:px-[48px] py-3 md:py-[12px] bg-accent text-background-primary body-text font-medium hover:bg-accent/90 transition-colors flex items-center justify-center gap-2 md:gap-[8px]";
