...
const faqQuestions = [
  ...
  "Подойдёт ли Mute для звонков вдвоём?",
      ...
      <main className="container">
        <article className="max-w-[920px] mx-auto pt-10 md:pt-14 lg:pt-[72px] pb-12 md:pb-16 lg:pb-[80px]">
          ...
          {/* Формулировки из поисковых запросов сентября 2026 с высокой
              вовлечённостью: «позвонить другу на пк без впн», «бесплатный
              войс по ссылке», «как дискорд без впн», «гс чаты для россии». */}
          <h2 className={h2}>Позвонить другу на ПК без VPN и без сервера</h2>
          <p className={p}>
            Если нужно просто позвонить другу на компьютер и поговорить, пока
            идёт игра, Mute для этого и сделан: ни сервера, ни каналов, ни
            настройки. Отправили ссылку, друг открыл её в браузере, и вы уже в
            звонке. Это бесплатный войс по ссылке для своей компании: комната
            до 8 человек живёт постоянно, заходить в неё можно каждый вечер, а
            посторонний без приглашения в неё не попадёт.
          </p>
          <p className={p}>
            Тем, кто ищет приложение для звонков вроде Discord, но
            открывающееся в России, подойдёт та же схема: звонки один на один
            без лимита времени, голосовые комнаты, текстовые чаты, видео и
            демонстрация экрана. Публичных серверов и push-to-talk в Mute нет,
            и это осознанно. Подробное сравнение на{" "}
            <Link href="/discord-alternative" className={link}>
              странице про аналог Discord
            </Link>
            .
          </p>
          ...
          <p className={p}>
            Сайт для созвона или звонков с друзьями сейчас выбирают по одному признаку:
          ...
          <h2 className={h2}>Звонки через браузер, даже на телефоне</h2>
          <p className={p}>
          ...
          <h2 className={h2}>Голосовой чат для двоих и для компании друзей</h2>
          <p className={p}>
