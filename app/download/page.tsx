    ...
    <>
      ...
      <main className="container">
        ...
        <article className="max-w-[920px] mx-auto pb-12 md:pb-16 lg:pb-[80px]">
          ...
          <h2 className={h2}>Что внутри: голосовой чат для игр на ПК</h2>
          <p className={p}>
            Mute сделан как программа для общения и созвона в играх на ПК, с
            демонстрацией экрана и видео: звонки один на один без
            ...
            нет: микрофон включается и выключается кнопкой. Ищут его
            по-разному: приложение для голосового общения в играх, программа
            для общения голосом на ПК, чат для геймеров. Это одно и то же окно
            со списком друзей.
          </p>
