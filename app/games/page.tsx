...
const GROUPS: Array<{ key: GameTopic; title: string; lead: string }> = [
  ...
  {
    key: "novoice",
    title: "Нет встроенного войса",
    lead: "Голоса в игре нет вовсе: только текст, быстрые фразы или моды. Что есть внутри на самом деле и как созвониться рядом с игрой, чтобы компания слышала друг друга.",
  },
  {
    key: "setup",
    title: "Настройка",
